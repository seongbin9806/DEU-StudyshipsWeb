!function(e, t) {
    ...
    const D = "SweetAlert2:"
      ...
      , J = e=>{
        ...
        for (const n in e)
            ...
            e.toast && (t = n,
            K.includes(t) && a('The parameter "'.concat(t, '" is incompatible with toasts'))),
            t = n,
            Z(t) && N(t, Z(t));
        var t
    }
    ...
    const He = (e,t)=>{
        ...
        o = i,
        (n = t.position)in p ? w(o, p[n]) : (a('The "position" parameter is not valid, defaulting to "center"'),
        w(o, p.center)),
        n = i,
    ...
    const De = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
      ...
      , L = {}
      , We = (L.text = L.email = L.password = L.number = L.tel = L.url = (e,t)=>(Fe(e, t.inputValue),
    Re(e, e, t),
    Ne(e, t),
    e.type = t.input,
    e),
    ...
    (e,t)=>{
        ...
        v(n, t, "htmlContainer"),
        t.html ? (Le(t.html, n),
        P(n, "block")) : t.text ? (n.textContent = t.text,
        P(n, "block")) : B(n),
        qe(e, t)
    }
    )
      ...
      , $e = (e,t)=>{
        let n = e.innerHTML, o;
        var i;
        t.iconHtml ? o = Ge(t.iconHtml) : "success" === t.icon ? (o = Je,
      ...
      , ot = (e,t)=>{
        var n = m();
        const o = g();
        t.toast ? (A(n, "width", t.width),
        o.style.width = "100%",
        o.insertBefore(d(), X())) : A(o, "width", t.width),
        A(o, "padding", t.padding),
        t.color && (o.style.color = t.color),
        t.background && (o.style.background = t.background),
        B(te());
        n = o;
        (n.className = "".concat(p.popup, " ").concat(x(n) ? t.showClass.popup : ""),
      ...
      , ut = e=>{
        ...
        return n && (j(n, ["src", "width", "height", "alt"]),
      ...
      , pt = e=>{
        ...
        t && (j(t, ["type", "label", "placeholder", "value"]),
    ...
    const yt = ()=>{
        null === s.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (s.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
        document.body.style.paddingRight = "".concat(s.previousBodyPadding + (()=>{
      ...
      , vt = ()=>{
        null !== s.previousBodyPadding && (document.body.style.paddingRight = "".concat(s.previousBodyPadding, "px"),
      ...
      , kt = ()=>{
        var e;
        c(document.body, p.iosfix) && (e = parseInt(document.body.style.top, 10),
      ...
      , Tt = (t,n)=>{
        ...
        U(n.inputOptions) || F(n.inputOptions) ? (M(h()),
    ...
    function Mt() {
        ...
        if (t) {
            ...
            B(n.loader),
            ce() ? t.icon && P(X()) : (t = n,
            (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? P(e[0], "inline-block") : fe() && B(t.actions)),
            ...
            "Enter" === n.key)
                ...
                if (!(document.activeElement instanceof HTMLElement) || [l, u, d].includes(document.activeElement)) {
                    ...
                    for (let e = 0; e < ne().children.length; e++) {
                        if (!(t = t[c]))
                            return;
                        if (t instanceof HTMLButtonElement && x(t))
                            break
                    }
    ...
    const Wt = e=>{
        e.isAwaitingPromise() && (S.awaitingPromise.delete(e),
      ...
      , zt = (e,t,n)=>{
        ...
        o.addEventListener(je, function(e) {
            e.target === o && (E.swalCloseEventFinishedCallback(),
    ...
    const Zt = e=>{
        e.isAwaitingPromise() ? (Jt(S, e),
        S.awaitingPromise.set(e, !0)) : (Jt(It, e),
        Jt(S, e))
    }
      , Jt = (e,t)=>{
        for (const n in e)
    ...
    e = Object.freeze({
            ...
            t = (t=>{
                ...
                return Object.keys(t).forEach(e=>{
                    if (Y(e))
                        ...
                        a("Invalid parameter to update: ".concat(e))
                }
                ),
                n
            }
        ...
        _destroy: function() {
            ...
            delete E.currentInstance) : Zt(this)
        }
    });
    const Xt = (e,t)=>{
        ...
        if (n.inputValidator) {
            ...
            e.getInput().checkValidity() ? ("deny" === t ? $t : en)(e, o) : (e.enableButtons(),
      ...
      , en = (t,n)=>{
        ...
        e.preConfirm) {
            ...
            o.then(e=>{
                x(te()) || !1 === e ? (t.hideLoading(),
                Wt(t)) : Qt(t, void 0 === e ? n : e)
            }
            ).catch(e=>Gt(t || void 0, e))
        } else
            Qt(t, n)
    ...
    const hn = (l,u,d)=>new Promise((e,t)=>{
        ...
        t = u,
        a = n,
        S.innerParams.get(e).toast ? tn(e, t, a) : (on(t),
        an(t),
        rn(e, t, a)),
        o = l,
        e = E,
        ...
        a = l,
        "select" === (t = d).input || "radio" === t.input ? Tt(a, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (U(t.inputValue) || F(t.inputValue)) && (M(h()),
        St(a, t));
        {
            var r = d;
            const s = m()
      ...
      , wn = (e,t)=>t.focusDeny && x(e.denyButton) ? (e.denyButton.focus(),
    ...
    !0)
      ...
      , kn = (Object.assign(H.prototype, e),
    Object.assign(H, gn),
